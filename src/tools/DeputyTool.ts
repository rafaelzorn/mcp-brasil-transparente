...
import type { DeputyService } from "@/services/DeputyService";
				...
				try {
					...
					return {
						content: [
							{
								type: "text",
								text: "Ops... Ocorreu um erro ao buscar os deputados.",
							},
						],
						structuredContent: { data: [] },
					};
        ...
        `,
				...
				outputSchema: {
					...
					lastStatus: z.object({
						...
						electoralCondition: z
							.string()
							.describe("Condição eleitoral do deputado"),
					}),
					cpf: z.string().describe("CPF do deputado"),
					socialMedia: z
						.array(z.string())
						.describe("Redes sociais do deputado"),
					birthDate: z.string().describe("Data de nascimento do deputado"),
					deathDate: z
						.string()
						.nullable()
						.describe("Data de falecimento do deputado"),
					birthState: z
						.string()
						.describe("Sigla do estado de nascimento do deputado"),
				...
				try {
					...
					return {
						content: [
							{
								type: "text",
								text: "Ops... Ocorreu um erro ao consultar detalhes do deputado.",
							},
						],
						structuredContent: {},
					};
